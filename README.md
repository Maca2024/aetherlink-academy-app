...
Dit is een lokaal pilot-MVP: de driverrol stuurt de werkvorm, geen exclusief schrijfrecht in Proof. Alle menselijke editors kunnen het document bewerken. Namen/squadcodes zijn geen geverifieerde identiteit. Naast de vijf supportdagen bevat de Worldline Course nu de volledige 9-weekse route van AI Foundations tot RALF & Scale, met de oorspronkelijke lessen, labs, meertalige content en deelnemergebonden voortgang. Enkele native Proof-bedieningen zijn Engels. Liveblocks is beoordeeld maar niet geïntegreerd. De broncoderepository is [Maca2024/aetherlink-academy-app](https://github.com/Maca2024/aetherlink-academy-app) met [RyanLisse/aetherlink-academy-app](https://github.com/RyanLisse/aetherlink-academy-app) als upstream. De publieke deployment draait op de Hetzner CX33 `aetherlink-academy` (http://91.99.78.17:4317). Deployed acceptatie wordt bewezen met `scripts/deployed-mcp-check.mjs` en `scripts/deployed-browser-acceptance.mjs`; zie [handleiding deelnemer](docs/handleiding-deelnemer.md) en [handleiding facilitator](docs/handleiding-facilitator.md).
