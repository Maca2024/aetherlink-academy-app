...
export const curriculum: CurriculumWeek[] = [
  ...
  // ── WEEK 8-9: CONSOLIDATIE ──
  {
    ...
    badgeIcon: '🏆',
      ...
      {
        id: 'w8-q3',
        question: 'Wat is de EU AI Act Artikel 4 deadline voor Worldline compliance met hoog-risico AI-systemen?',
        questionI18n: {
          en: 'What is the EU AI Act Article 4 deadline for Worldline compliance with high-risk AI systems?',
          nl: 'Wat is de EU AI Act Artikel 4 deadline voor Worldline compliance met hoog-risico AI-systemen?',
          fr: 'Quelle est la date limite de l\'article 4 de l\'EU AI Act pour la conformité de Worldline avec les systèmes IA à haut risque ?',
        },
        options: ['Februari 2025', 'Augustus 2026', 'Januari 2027', 'Augustus 2028'],
        optionsI18n: {
          en: ['February 2025', 'August 2026', 'January 2027', 'August 2028'],
          nl: ['Februari 2025', 'Augustus 2026', 'Januari 2027', 'Augustus 2028'],
          fr: ['Février 2025', 'Août 2026', 'Janvier 2027', 'Août 2028'],
        },
        correctIndex: 1,
        explanation: 'Augustus 2026 is de deadline voor volledige compliance van hoog-risico AI-systemen (inclusief fraudedetectie in financiële diensten). Als Worldline developer is dit jouw deadline voor systemen die je bouwt en beheert.',
        explanationI18n: {
          en: 'August 2026 is the deadline for full compliance of high-risk AI systems (including fraud detection in financial services). As a Worldline developer, this is your deadline for the systems you build and operate.',
          nl: 'Augustus 2026 is de deadline voor volledige compliance van hoog-risico AI-systemen (inclusief fraudedetectie in financiële diensten). Als Worldline developer is dit jouw deadline voor systemen die je bouwt en beheert.',
          fr: 'Août 2026 est la date limite pour la conformité complète des systèmes IA à haut risque (y compris la détection de fraude dans les services financiers). En tant que développeur Worldline, c\'est votre échéance pour les systèmes que vous construisez et exploitez.',
        },
        bloomLevel: 1,
...
export const aiLiteracyComplianceTest: McqQuestion[] = [
  ...
  {
    id: 'cmp-05',
    question: 'Wanneer treedt de volledige EU AI Act handhaving in werking voor hoog-risico AI-systemen?',
    questionI18n: {
      en: 'When does full EU AI Act enforcement come into effect for high-risk AI systems?',
      nl: 'Wanneer treedt de volledige EU AI Act handhaving in werking voor hoog-risico AI-systemen?',
      fr: 'Quand l\'application complète de l\'EU AI Act entre-t-elle en vigueur pour les systèmes IA à haut risque ?',
    },
    options: ['Augustus 2024', 'Februari 2025', 'Augustus 2026', 'Januari 2028'],
    optionsI18n: {
      en: ['August 2024', 'February 2025', 'August 2026', 'January 2028'],
      nl: ['Augustus 2024', 'Februari 2025', 'Augustus 2026', 'Januari 2028'],
      fr: ['Août 2024', 'Février 2025', 'Août 2026', 'Janvier 2028'],
    },
    correctIndex: 2,
    explanation: 'De volledige verplichtingen voor hoog-risico AI-systemen gaan in per augustus 2026. Dit is de deadline voor Worldline-compliance.',
    explanationI18n: {
      en: 'The full obligations for high-risk AI systems come into effect August 2026. This is the deadline for Worldline compliance.',
      nl: 'De volledige verplichtingen voor hoog-risico AI-systemen gaan in per augustus 2026. Dit is de deadline voor Worldline-compliance.',
      fr: 'Les obligations complètes pour les systèmes IA à haut risque entrent en vigueur en août 2026. C\'est la deadline pour la conformité Worldline.',
    },
    bloomLevel: 1,
    euAiActRelevant: true,
    points: 10,
