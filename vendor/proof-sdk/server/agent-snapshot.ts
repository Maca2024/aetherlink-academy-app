...
import type { DocumentRow, DocumentBlockRow } from './db-postgres.js';
import { getDocumentBySlug, listLiveDocumentBlocks } from './db-postgres.js';
import {
...
async function buildSnapshotPayload(
  ...
  const storedBlocks = (await listLiveDocumentBlocks(document.doc_id));
