...
export async function evaluateRewriteLiveClientGate(slug: string, body: unknown): Promise<RewriteLiveClientGate> {
...
export async function evaluateRewriteLiveClientGateWithOptions(
  slug: string,
  body: unknown,
  options: RewriteLiveClientGateOptions,
): Promise<RewriteLiveClientGate> {
